...
class ForumsTest extends TestCase
{
    ...
    {
        $thread = create('NIHILCo\Forums\Models\Thread', ['forum_id' => $this->forum->id]);
    ...
    public function test_a_user_can_create_a_new_forum()
    {
        ...
        $newForum = make('NIHILCo\Forums\Models\Forum');
    ...
    public function publishForum($overrides = [])
    {
        ...
        $newForum = make('NIHILCo\Forums\Models\Forum', $overrides);
    ...
    public function test_a_forum_can_be_deleted()
    {
        ...
        $newForum = create('NIHILCo\Forums\Models\Forum', ['user_id' => auth()->id()]);
//        $newThread = create('NIHILCo\Forums\Models\Thread', ['forum_id' => $newForum->id]);
