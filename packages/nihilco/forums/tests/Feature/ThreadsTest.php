...
class ThreadsTest extends TestCase
{
    ...
    public function publishThread($overrides = [])
    {
        ...
        $newThread = make('NIHILCo\Forums\Models\Thread', $overrides);
    ...
    {
        $reply = create('NIHILCo\Forums\Models\Reply', ['thread_id' => $this->thread->id]);
    ...
    public function test_a_user_can_create_a_new_thread()
    {
        ...
        $newThread = make('NIHILCo\Forums\Models\Thread');
    ...
    {
        $newForum = create('NIHILCo\Forums\Models\Forum');
        $newThreadInForum = create('NIHILCo\Forums\Models\Thread', ['forum_id' => $newForum->id]);
        $newThreadNotInForum = create('NIHILCo\Forums\Models\Thread');
    ...
    public function test_a_user_can_filter_threads_by_username()
    {
        ...
        $threadByJohn = create('NIHILCo\Forums\Models\Thread', ['user_id' => auth()->id()]);
        $threadNotByJohn = create('NIHILCo\Forums\Models\Thread');
    ...
    {
        $threadWithTwentySevenReplies = create('NIHILCo\Forums\Models\Thread');
        create('NIHILCo\Forums\Models\Reply', ['thread_id' => $threadWithTwentySevenReplies->id], 27);

        $threadWithTwentyEightReplies = create('NIHILCo\Forums\Models\Thread');
        create('NIHILCo\Forums\Models\Reply', ['thread_id' => $threadWithTwentyEightReplies->id], 28);

        $threadWithTwentySixReplies = create('NIHILCo\Forums\Models\Thread');
        create('NIHILCo\Forums\Models\Reply', ['thread_id' => $threadWithTwentySixReplies->id], 26);
    ...
    {
        $newThread = create('NIHILCo\Forums\Models\Thread');
    ...
    public function test_a_thread_can_be_deleted()
    {
        ...
        $newThread = create('NIHILCo\Forums\Models\Thread', ['user_id' => auth()->id()]);
        $newReply = create('NIHILCo\Forums\Models\Reply', ['thread_id' => $newThread->id]);
        $newThreadVote = create('NIHILCo\Forums\Models\Vote', ['resource_id' => $newThread->id, 'resource_type' => \NIHILCo\Forums\Models\Thread::class]);
