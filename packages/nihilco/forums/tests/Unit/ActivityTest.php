...
class ActivityTest extends TestCase
{
    ...
    public function test_records_activity_when_a_thread_is_created()
    {
        ...
        $thread = create('NIHILCo\Forums\Models\Thread', ['user_id' => auth()->id()]);
    ...
    public function test_records_activity_when_created()
    {
        ...
        $forum = create('NIHILCo\Forums\Models\Forum', ['user_id' => auth()->id()]);
        $thread = create('NIHILCo\Forums\Models\Thread', ['user_id' => auth()->id(), 'forum_id' => $forum->id]);
        $reply = create('NIHILCo\Forums\Models\Reply', ['user_id' => auth()->id(), 'thread_id' => $thread->id]);
