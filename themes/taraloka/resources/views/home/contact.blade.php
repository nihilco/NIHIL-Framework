...
@section('meta')
      ...
      <meta name="og:url" property="og:url" content="https://taraloka.org/contact">
...
{{ csrf_field() }}
    ...
    <p class="help-block help-block-error"></p>
                                              ...
                                              <button type="submit" class="btn btn-primary btn-lg pull-right" name="contact-button">Submit</button>                                      </div>
    </form>
