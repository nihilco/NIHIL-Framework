...
<html lang="en">
      ...
      <title>Shoe Fundraiser - Taraloka</title>
      ...
      <div class="row">
        ...
        <div class="col-sm-9 col-md-10" style="padding-right: 0;">
          ...
          <a href="/register" class="btn btn-mystic">register</a>
                <a href="/logoin" class="btn btn-mystic">login</a>
                ...
                <div class="container-fluid">
                  ...
                  <div class="collapse navbar-collapse" id="bs-example-navbar-collapse-1">
                    <ul class="nav navbar-nav">
                      ...
                      <li><a class="btn btn-default" id="navbar-btn" href="#">donate</a></li>
                    </ul>
...
<form>
       ...
       <div class="form-group">
         <div class="col-xs-3">
           <label class="btn btn-success" style="padding:0; margin-bottom:10px;">
             <img src="/img/girls/bimla.png" alt="..." class="img-thumbnail img-check" style="border:0;padding:0;">
             <input type="checkbox" name="chk1" id="item4" value="val1" class="hidden" autocomplete="off">
           </label>
         </div>
         <div class="col-xs-3">
           <label class="btn btn-success" style="padding:0; margin-bottom:10px;">
             <img src="/img/girls/binita.png" alt="..." class="img-thumbnail img-check" style="border:0;padding:0;">
             <input type="checkbox" name="chk1" id="item4" value="val1" class="hidden" autocomplete="off">
           </label>
         </div>
         <div class="col-xs-3">
       ...
       <div class="col-sm-4" style="margin-top:21px;">
         ...
         <div class="form-group">
           ...
           <input type="email" class="form-control" placeholder="jsmith@exapmle.com">
         </div>
         <div class="form-group">
  ...
  <div id="footer-navigation">
    <div class="container">
          ...
          <div class="row">
            <div class="col-sm-12 text-center">
              ...
              <ul class="list-unstyled" id="footer-menu">
                ...
                <!--<li><a href="#">shop</a></li>-->
                <li><a href="#">contact</a></li>
                <li><a href="#" class="btn btn-default">donate</a></li>
              </ul>
      ...
      <div class="row" id="footer-legal">
        ...
        <div class="col-sm-8">
          <p>Copyright 2014 &copy; <strong class="font-green">The Taraloka Foundation</strong>.  All rights reserved.  <a href="#" style="margin:0 10px">Privacy</a>  <a href="#" style="margin:0 5px">Terms</a></p>
        </div>
