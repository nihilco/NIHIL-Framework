...
@section('content')
    ...
    @include('layouts.breadcrumbs', ['breadcrumbs' => [
        ['label' => 'Publishers', 'url' => '/publishers'],
    ]])
  ...
  <div class="row">
    ...
    <table class="table table-bordered">
      ...
      <tbody>
        ...
        <tr>
          <th scope="row"><a href="{{ $publisher->path() }}">{{ $publisher->name }}</a></th>
    ...
    @else
    <p>No publishers at this time.</td></tr>
    @endif
    ...
    <div class="col">
      <div class="card">
            <div class="card-block">
    @if(!Auth::guest())
        <a href="/publishers/create" class="btn btn-lg btn-primary pull-right">New Publisher</a>
    @else
    Please <a href="{{ route('login') }}">login</a> to manage publishers.
    @endif    
