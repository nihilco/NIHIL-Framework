...
@section('content')
    ...
    @include('layouts.breadcrumbs', ['breadcrumbs' => [
        ['label' => 'Resolutions', 'url' => '/resolutions'],
    ]])
  ...
  <div class="row">
    ...
    <table class="table table-bordered">
      ...
      <tbody>
        ...
        <tr>
          <th scope="row"><a href="{{ $resolution->path() }}">{{ $resolution->name }}</a></th>
          <td>{{ $resolution->updated_at->diffForHumans() }}</td>
          <th>&nbsp;</th>
        </tr>
        @endforeach
      </tbody>
    ...
    @else
    <p>No resolutions at this time.</td></tr>
    @endif
    ...
    <div class="col">
      <div class="card">
            <div class="card-block">
    @if(!Auth::guest())
        <a href="/resolutions/create" class="btn btn-lg btn-primary pull-right">New Resolution</a>
    @else
    Please <a href="{{ route('login') }}">login</a> to manage resolutions.
    @endif    
