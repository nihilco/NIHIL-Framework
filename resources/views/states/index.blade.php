  ...
  <div class="row">
    ...
    <table class="table table-bordered">
      ...
      <tbody>
        ...
        <tr>
          <th scope="row"><a href="{{ $state->path() }}">{{ $state->name }}</a></th>
          <td>{{ $state->abbr }}</td>
    ...
    @else
    <p>No states at this time.</td></tr>
    @endif
    ...
    <div class="col">
      <div class="card">
            <div class="card-block">
    @if(!Auth::guest())
        <a href="/states/create" class="btn btn-lg btn-primary pull-right">New State</a>
    @else
    Please <a href="{{ route('login') }}">login</a> to manage states.
    @endif    
