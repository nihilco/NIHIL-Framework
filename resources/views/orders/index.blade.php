  ...
  <div class="row">
    ...
    <table class="table table-bordered">
      ...
      <tbody>
        ...
        <tr>
          <th scope="row"><a href="{{ $order->path() }}">{{ $order->customer->strip_id }}</a></th>
    ...
    @else
    <p>No orders at this time.</td></tr>
    @endif
    ...
    <div class="col">
      <div class="card">
            <div class="card-block">
    @if(!Auth::guest())
        <a href="/orders/create" class="btn btn-lg btn-primary pull-right">New Order</a>
    @else
    Please <a href="{{ route('login') }}">login</a> to manage orders.
    @endif    
