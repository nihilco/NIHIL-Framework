  ...
  <div class="row">
    ...
    <table class="table table-bordered">
      ...
      <tbody>
        ...
        <tr>
          <th scope="row"><a href="{{ $email->path() }}">{{ $email->subject }}</a></th>
          <td>{{ $email->from }}</td>
          <td>{{ $email->to }}</td>
    ...
    @else
    <p>No emails at this time.</td></tr>
    @endif
    ...
    <div class="col">
      <div class="card">
            <div class="card-block">
    @if(!Auth::guest())
        <a href="/emails/create" class="btn btn-lg btn-primary pull-right">New Email</a>
    @else
    Please <a href="{{ route('login') }}">login</a> to manage emails.
    @endif    
