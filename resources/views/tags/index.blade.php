  ...
  <div class="row">
    ...
    <table class="table table-bordered">
      ...
      <tbody>
        @foreach($tags as $tag)
        <tr>
          <th scope="row"><a href="{{ $tag->path() }}">{{ $tag->name }}</a></th>
    ...
    <div class="col">
      <div class="card">
            <div class="card-block">
    @if(!Auth::guest())
        <a href="/tags/create" class="btn btn-lg btn-primary pull-right">New Tag</a>
    @else
    Please <a href="{{ route('login') }}">login</a> to manage tags.
    @endif    
