...
@section('content')
  ...
  <div class="row">
    ...
    @else
    <p>No customers at this time.</td></tr>
    @endif
    ...
    <div class="col">
      <div class="card">
            <div class="card-block">
    @if(!Auth::guest())
        <a href="/customers/create" class="btn btn-lg btn-primary pull-right">New Customer</a>
    @else
    Please <a href="{{ route('login') }}">login</a> to manage customers.
    @endif    
