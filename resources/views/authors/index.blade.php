  ...
  <div class="row">
    ...
    <table class="table table-bordered">
      ...
      <tbody>
        ...
        <tr>
          <th scope="row"><a href="{{ $author->path() }}">{{ $author->last_name }}</a></th>
    ...
    @else
    <p>No authors at this time.</td></tr>
    @endif
    ...
    <div class="col">
      <div class="card">
            <div class="card-block">
    @if(!Auth::guest())
        <a href="/authors/create" class="btn btn-lg btn-primary pull-right">New Author</a>
    @else
    Please <a href="{{ route('login') }}">login</a> to manage authors.
    @endif    
