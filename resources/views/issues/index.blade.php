...
@section('content')
    ...
    @include('layouts.breadcrumbs', ['breadcrumbs' => [
        ...
        ['label' => 'Issues', 'url' => '/support/issues'],
    ]])
  ...
  <div class="row">
    ...
    <table class="table table-bordered">
      ...
      <tbody>
        ...
        <tr>
          <th scope="row"><a href="{{ $issue->path() }}">{{ $issue->title }}</a></th>
    ...
    @else
    <p>No issues at this time.</td></tr>
    @endif
    ...
    <div class="col">
      <div class="card">
            <div class="card-block">
    @if(!Auth::guest())
        <a href="/support/issues/create" class="btn btn-lg btn-primary pull-right">New Issue</a>
    @else
    Please <a href="{{ route('login') }}">login</a> to manage issues.
    @endif    
