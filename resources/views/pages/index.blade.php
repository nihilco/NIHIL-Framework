  ...
  <div class="row">
    ...
    <table class="table table-bordered">
      ...
      <tbody>
        ...
        <tr>
          <th scope="row"><a href="{{ $page->path() }}">{{ $page->title }}</a></th>
    ...
    <div class="col">
      <div class="card">
            <div class="card-block">
    @if(!Auth::guest())
        <a href="/pages/create" class="btn btn-lg btn-primary pull-right">New Page</a>
    @else
    Please <a href="{{ route('login') }}">login</a> to manage pages.
    @endif    
