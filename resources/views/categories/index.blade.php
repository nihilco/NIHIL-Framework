  ...
  <div class="row">
    ...
    <table class="table table-bordered">
      ...
      <tbody>
        ...
        <tr>
          <th scope="row"><a href="{{ $category->path() }}">{{ $category->name }}</a></th>
    ...
    @else
    <p>No categories at this time.</td></tr>
    @endif
    ...
    <div class="col">
      <div class="card">
            <div class="card-block">
    @if(!Auth::guest())
        <a href="/categories/create" class="btn btn-lg btn-primary pull-right">New Category</a>
    @else
    Please <a href="{{ route('login') }}">login</a> to manage categories.
    @endif    
