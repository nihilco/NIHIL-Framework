...
@section('content')
  ...
  <div class="row">
    ...
    @else
    <p>No invoices at this time.</td></tr>
    @endif
    ...
    <div class="col">
      <div class="card">
            <div class="card-block">
    @if(!Auth::guest())
        <a href="/invoices/create" class="btn btn-lg btn-primary pull-right">New Invoice</a>
    @else
    Please <a href="{{ route('login') }}">login</a> to manage invoices.
    @endif    
