  ...
  <div class="row">
    ...
    <table class="table table-bordered">
      ...
      <tbody>
        ...
        <tr>
          <th scope="row"><a href="{{ $group->path() }}">{{ $group->name }}</a></th>
          <td>{{ $group->color }}</td>
    ...
    @else
    <p>No groups at this time.</td></tr>
    @endif
    ...
    <div class="col">
      <div class="card">
            <div class="card-block">
    @if(!Auth::guest())
        <a href="/groups/create" class="btn btn-lg btn-primary pull-right">New Group</a>
    @else
    Please <a href="{{ route('login') }}">login</a> to manage groups.
    @endif    
