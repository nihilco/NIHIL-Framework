  ...
  <div class="row">
    ...
    <table class="table table-bordered">
      ...
      <tbody>
        ...
        <tr>
          <th scope="row"><a href="{{ $product->path() }}">{{ $product->name }}</a></th>
    ...
    @else
    <p>No products at this time.</td></tr>
    @endif
    ...
    <div class="col">
      <div class="card">
            <div class="card-block">
    @if(!Auth::guest())
        <a href="/products/create" class="btn btn-lg btn-primary pull-right">New Product</a>
    @else
    Please <a href="{{ route('login') }}">login</a> to manage products.
    @endif    
