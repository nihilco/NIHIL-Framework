  ...
  <div class="row">
    ...
    <table class="table table-bordered">
      ...
      <tbody>
        ...
        <tr>
          <th scope="row"><a href="{{ $address->path() }}">{{ $address->resource_type }}</a></th>
    ...
    @else
    <p>No addresses at this time.</td></tr>
    @endif
    ...
    <div class="col">
      <div class="card">
            <div class="card-block">
    @if(!Auth::guest())
        <a href="/addresses/create" class="btn btn-lg btn-primary pull-right">New Address</a>
    @else
    Please <a href="{{ route('login') }}">login</a> to manage addresses.
    @endif    
