  ...
  <div class="row">
    ...
    <table class="table table-bordered">
      ...
      <tbody>
        ...
        <tr>
          <th scope="row"><a href="{{ $region->path() }}">{{ $region->name }}</a></th>
          <td>{{ $region->abbr }}</td>
    ...
    @else
    <p>No regions at this time.</td></tr>
    @endif
    ...
    <div class="col">
      <div class="card">
            <div class="card-block">
    @if(!Auth::guest())
        <a href="/regions/create" class="btn btn-lg btn-primary pull-right">New Region</a>
    @else
    Please <a href="{{ route('login') }}">login</a> to manage regions.
    @endif    
