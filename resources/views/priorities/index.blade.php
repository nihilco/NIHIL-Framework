...
@section('content')
    ...
    @include('layouts.breadcrumbs', ['breadcrumbs' => [
        ['label' => 'Priorities', 'url' => '/priorities'],
    ]])
  ...
  <div class="row">
    ...
    <table class="table table-bordered">
      ...
      <tbody>
        ...
        <tr>
          <th scope="row"><a href="{{ $priority->path() }}">{{ $priority->name }}</a></th>
    ...
    @else
    <p>No priorities at this time.</td></tr>
    @endif
    ...
    <div class="col">
      <div class="card">
            <div class="card-block">
    @if(!Auth::guest())
        <a href="/priorities/create" class="btn btn-lg btn-primary pull-right">New Priority</a>
    @else
    Please <a href="{{ route('login') }}">login</a> to manage priorities.
    @endif    
