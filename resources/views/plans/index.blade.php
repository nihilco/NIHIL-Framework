  ...
  <div class="row">
    ...
    <table class="table table-bordered">
      ...
      <tbody>
        ...
        <tr>
          <th scope="row"><a href="{{ $plan->path() }}">{{ $plan->name }}</a></th>
    ...
    <div class="col">
      <div class="card">
            <div class="card-block">
    @if(!Auth::guest())
        <a href="/plans/create" class="btn btn-lg btn-primary pull-right">New Plan</a>
    @else
    Please <a href="{{ route('login') }}">login</a> to manage plans.
    @endif    
