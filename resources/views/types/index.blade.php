  ...
  <div class="row">
    ...
    <table class="table table-bordered">
      ...
      <tbody>
        ...
        <tr>
          <th scope="row"><a href="{{ $type->path() }}">{{ $type->name }}</a></th>
    ...
    <div class="col">
      <div class="card">
            <div class="card-block">
    @if(!Auth::guest())
        <a href="/types/create" class="btn btn-lg btn-primary pull-right">New Type</a>
    @else
    Please <a href="{{ route('login') }}">login</a> to manage types.
    @endif    
