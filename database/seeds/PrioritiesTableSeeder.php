...
class PrioritiesTableSeeder extends Seeder
{
    ...
    {
        //
        $criticalPriority = factory('App\Models\Priority')->create([
            'creator_id' => 1,
            'name' => 'Critical',
            'slug' => 'critical',
        ...
        $highPriority = factory('App\Models\Priority')->create([
            'creator_id' => 1,
            'name' => 'High',
            'slug' => 'high',
        ...
        $mediumPriority = factory('App\Models\Priority')->create([
            'creator_id' => 1,
            'name' => 'Medium',
            'slug' => 'medium',
        ...
        $lowPriority = factory('App\Models\Priority')->create([
            'creator_id' => 1,
            'name' => 'Low',
            'slug' => 'low',
        ...
        $trivialPriority = factory('App\Models\Priority')->create([
            'creator_id' => 1,
            'name' => 'Trivial',
            'slug' => 'trivial',
